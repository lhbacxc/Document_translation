...
git clone https://github.com/blader/humanizer.git ~/.claude/skills/translation-humanizer
```

Or copy the skill file manually if you already have this repo cloned:

```bash
mkdir -p ~/.claude/skills/translation-humanizer
cp SKILL.md ~/.claude/skills/translation-humanizer/
```
...
git clone https://github.com/blader/humanizer.git ~/.config/opencode/skills/translation-humanizer
```

Or copy the skill file manually if you already have this repo cloned:

```bash
mkdir -p ~/.config/opencode/skills/translation-humanizer
cp SKILL.md ~/.config/opencode/skills/translation-humanizer/
```

> **Note:** OpenCode also scans `~/.claude/skills/` for compatibility, so if you use both tools, a single clone into `~/.claude/skills/translation-humanizer/` is enough.
